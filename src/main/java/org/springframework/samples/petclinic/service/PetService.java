...
public class PetService {
	...
	@Transactional
	public Collection<Pet> findAdoptablePets() throws DataAccessException {
		return this.petRepository.findAdoptables();
	}

	@Transactional(rollbackFor = DuplicatedPetNameException.class)
	public Pet savePet(final Pet pet) throws DataAccessException, DuplicatedPetNameException {
	...
	public void delete(final Pet pet) {
		if (pet.getVisits() == null && this.adoptionRepository.findAdoptionsByPet(pet.getId()) == null) {
