...
class PT_HU014 extends Simulation {
  ...
  setUp(
    updateProviderPositive.inject(rampUsers(1700) during (10 seconds)),
    updateProviderNegative.inject(rampUsers(1700) during (10 seconds))
