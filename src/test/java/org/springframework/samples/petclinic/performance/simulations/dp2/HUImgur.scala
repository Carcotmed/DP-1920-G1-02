...
class HUImgur extends Simulation {
  ...
  val headers_1 = Map(
    "Content-Type" -> "multipart/form-data; boundary=---------------------------27225957487655394562832592803",
  ...
  object SubmitImage {
    val submitImg = exec(
      http("SubmitImage")
        ...
        .headers(headers_1)
        .body(RawFileBody("dp2/huimgur/0001_request.dat"))
		.formParam("_csrf", "${stoken}")
    )
      .pause(4)
  }
