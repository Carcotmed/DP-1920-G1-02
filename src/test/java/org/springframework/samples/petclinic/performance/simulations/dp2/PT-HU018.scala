...
class PTHU018 extends Simulation {
	...
	object DeleteOrder{
		val deleteOrder = exec(http("DeleteOrder")
			.get("/orders/delete/2")
			.headers(headers_0))
		.pause(7)
	}
	...
	setUp(
	deleteOrderPositive.inject(rampUsers(200) during (10 seconds)),
	deleteOrderNegative.inject(rampUsers(200) during (10 seconds))
