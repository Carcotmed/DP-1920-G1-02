...
class PTHU020 extends Simulation {
	...
	setUp(
		editDiscountPositive.inject(rampUsers(200) during (10 seconds)),
		editDiscountNegative.inject(rampUsers(200) during (10 seconds))
