...
class PT_HU002 extends Simulation {
  ...
  setUp(
    newInterventionPositive.inject(rampUsers(1700) during (10 seconds)),
    newInterventionNegative.inject(rampUsers(1700) during (10 seconds))
