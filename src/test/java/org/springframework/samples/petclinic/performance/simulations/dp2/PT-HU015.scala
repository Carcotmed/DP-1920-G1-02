...
class PT_HU015 extends Simulation {
  ...
  setUp(
    deleteProviderPositive.inject(rampUsers(1700) during (10 seconds)),
    deleteProviderNegative.inject(rampUsers(1700) during (10 seconds))
