...
class AdoptionControllerTests {
	...
	void init() throws DataAccessException, DuplicatedPetNameException {
		...
		this.owner1.setId(AdoptionControllerTests.ido1);
		BDDMockito.given(this.ownerService.findOwnerById(AdoptionControllerTests.ido1)).willReturn(this.owner1);
		...
		this.owner2.setId(AdoptionControllerTests.ido2);
		BDDMockito.given(this.ownerService.findOwnerById(AdoptionControllerTests.ido2)).willReturn(this.owner2);

		this.pet1 = new Pet();
		this.pet1.setBirthDate(LocalDate.now().minusDays(10));
		this.pet1.setName("nameee1");
		this.pet1.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido1));
		this.pet1.setType(this.type1);
		this.pet1.setId(AdoptionControllerTests.idp1);
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.idp1)).willReturn(this.pet1);

		this.pet2 = new Pet();
		this.pet2.setBirthDate(LocalDate.now().minusDays(10));
		this.pet2.setName("nameee2");
		this.pet2.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido2));
		this.pet2.setType(this.type1);
		this.pet2.setId(AdoptionControllerTests.idp2);
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.idp2)).willReturn(this.pet2);

		this.pet3 = new Pet();
		this.pet3.setBirthDate(LocalDate.now().minusDays(10));
		this.pet3.setName("nameee3");
		this.pet3.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido1));
		this.pet3.setType(this.type1);
		this.pet3.setId(AdoptionControllerTests.idp3);
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.idp3)).willReturn(this.pet3);
		...
		this.pet4.setId(AdoptionControllerTests.idp4);
		BDDMockito.given(this.petService.findPetById(AdoptionControllerTests.idp4)).willReturn(this.pet4);

		this.adoption1 = new Adoption();
		this.adoption1.setDate(LocalDate.now().plusDays(3));
		this.adoption1.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido1));
		this.adoption1.setPet(this.petService.findPetById(AdoptionControllerTests.idp1));
		this.adoption1.setId(AdoptionControllerTests.ida1);
		BDDMockito.given(this.adoptionService.findById(AdoptionControllerTests.ida1)).willReturn(this.adoption1);
		...
		this.adoption2.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido2));
		this.adoption2.setPet(this.petService.findPetById(AdoptionControllerTests.idp2));
		this.adoption2.setId(AdoptionControllerTests.ida2);
		BDDMockito.given(this.adoptionService.findById(AdoptionControllerTests.ida2)).willReturn(this.adoption2);

		this.adoption3 = new Adoption();
		this.adoption2.setDate(LocalDate.now().plusDays(3));
		this.adoption2.setEnd(LocalDate.now().plusDays(30));
		this.adoption2.setOwner(this.ownerService.findOwnerById(AdoptionControllerTests.ido1));
		this.adoption2.setPet(this.petService.findPetById(AdoptionControllerTests.idp3));
		this.adoption2.setId(AdoptionControllerTests.ida3);
		BDDMockito.given(this.adoptionService.findById(AdoptionControllerTests.ida3)).willReturn(this.adoption3);
		...
		BDDMockito.given(this.adoptionService.findAdoptionsByOwner(AdoptionControllerTests.ido1)).willReturn(adoptions);
	...
	void testInitCreationFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/new/{petId}", AdoptionControllerTests.idp4)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("adoption"))
	...
	void testInitCreationFormAsVet() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/new/{petId}", AdoptionControllerTests.idp4)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testProcessCreationFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/new/{petId}", AdoptionControllerTests.idp4).requestAttr("end", LocalDate.parse("2030-02-02")).with(SecurityMockMvcRequestPostProcessors.csrf()))
	...
	void testProcessCreationFormFromAnotherOwner() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/new/{petId}", AdoptionControllerTests.idp2).requestAttr("end", LocalDate.parse("2030-02-02")).with(SecurityMockMvcRequestPostProcessors.csrf()))
	...
	void testProcessEmptyCreationFormSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/new/{petId}", AdoptionControllerTests.idp4).with(SecurityMockMvcRequestPostProcessors.csrf())).andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("error"))
	...
	void testProcessAdoptableCreationFormSuccess() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/adoptions/newAdoptable", AdoptionControllerTests.idp4).requestAttr("birthDate", LocalDate.parse("2010-02-02")).param("name", "prueba").requestAttr("type", this.petService.findPetTypes().iterator().next())
	...
	void testProcessAdoptableCreationFormEmpty() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.post("/adoptions/newAdoptable", AdoptionControllerTests.idp4).with(SecurityMockMvcRequestPostProcessors.csrf())).andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("error"))
	...
	void testDeleteAdoptionSuccess() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/delete/{adoptionId}", AdoptionControllerTests.ida1)).andExpect(MockMvcResultMatchers.model().attributeDoesNotExist("error")).andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.view().name("adoptions/allAdoptionsList"));
	}
	...
	void testDeleteAdoptionAsOwner() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/adoptions/delete/{adoptionId}", AdoptionControllerTests.ida1)).andExpect(MockMvcResultMatchers.model().attribute("error", "Only administrators can delete adoptions"))
			.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.view().name("adoptions/adoptionsList"));
	}
}
