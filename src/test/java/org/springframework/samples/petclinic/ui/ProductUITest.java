...
class ProductUITest {
	...
	void testListProductPositiveUI() throws Exception {
		...
		assertEquals("Jeringuilla",
				driver.findElement(By.xpath("//table[@id='productsTable']/tbody/tr[4]/td")).getText());
	...
	void testCreateProductNegativeUI() throws Exception {
		...
		assertEquals("tiene que ser mayor o igual que 0",
				driver.findElement(By.xpath("//form[@id='product-edit-form']/div/div[2]/div/span[2]")).getText());
		assertEquals("no puede ser null",
				driver.findElement(By.xpath("//form[@id='product-edit-form']/div/div[3]/div/span[2]")).getText());
	}
